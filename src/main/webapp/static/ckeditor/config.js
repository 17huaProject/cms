...
CKEDITOR.stylesSet.add( 'default', [
	...
	/* Object Styles */
	{ name : '图片左对齐', element : 'img', attributes : { 'style' : 'display:block; float:left'} },
	{ name : '图片右对齐', element : 'img', attributes : { 'style' : 'display:block; float:right'} },
	{ name : '图片居中', element : 'img', attributes : { 'style' : 'display:block; margin-left:auto; margin-right:auto'} },
