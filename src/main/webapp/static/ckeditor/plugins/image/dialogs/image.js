    ...
    var a = function(b, c) {
        ...
        k = function() {
            ...
            if (C.lockRatio) {
                ...
                if (E.getCustomData('isReady') == 'true') if (this.id == 'txtHeight') {
        ...
        return {
            ...
            },
            {
                ...
                elements: [{
                    ...
                    commit: function(B, C) {
                        var E = this;
                        if (B == e) if (E.getValue() || E.isChanged()) {
                ...
                },
                {
                    ...
                    commit: function(B, C) {
                        if (B == e) if (this.getValue() || this.isChanged()) C.setAttribute('target', this.getValue());
                    }
                }]
            },
            {
            ...
            },
            {
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        commit: function(B, C) {
                            if (B == d) if (this.getValue() || this.isChanged()) C.setAttribute('id', this.getValue());
                        }
                    },
                    {
                        id: 'cmbLangDir',
                        ...
                        commit: function(B, C) {
                            if (B == d) if (this.getValue() || this.isChanged()) C.setAttribute('dir', this.getValue());
                        }
                    },
                    {
                        type: 'text',
                        ...
                        commit: function(B, C) {
                            if (B == d) if (this.getValue() || this.isChanged()) C.setAttribute('lang', this.getValue());
                        }
                    }]
                },
                {
                    ...
                    commit: function(B, C) {
                        if (B == d) if (this.getValue() || this.isChanged()) C.setAttribute('longDesc', this.getValue());
                    }
                },
                {
                    type: 'hbox',
                    ...
                    children: [{
                        ...
                        commit: function(B, C) {
                            if (B == d) if (this.getValue() || this.isChanged()) C.setAttribute('class', this.getValue());
                        }
                    },
                    {
                        type: 'text',
