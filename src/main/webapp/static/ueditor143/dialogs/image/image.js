...
//                actionUrl = editor.getActionUrl(editor.getOpt('imageActionName')),
                actionUrl = editor.getOpt('imageMultiActionName'),
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                data.fileType = "image";
                /*
                //: get upyun parameters(policy、authorization) from  Customer Server
                var bucket, signature ,policy , returnUrl , expiration ;
                $.ajaxSetup({async:false});
                $.getJSON(editor.getOpt('upyunParametersUrl') + '?saveFolder=' + editor.getOpt('imagePathFormat') , function(data){
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                ajax.request(url, {
                    ...
                    'data': utils.extend({
                            ...
                            size: this.listSize,
                            upYunSaveFolder: editor.getOpt('imageManagerListPath')
                    ...
                    'onsuccess': function (r) {
                        try {
                            ...
                            if(r.responseText.indexOf('ue_separate_ue') != -1) {
                                var list = r.responseText.split('ue_separate_ue');
                                _this.pushData(list);
