...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            $("body").append('<div id="colorpanel" style="position: absolute; display: none; z-index: 999999999;"></div>');
            var colorTable = '';
            var colorValue = '';
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
            ...
            +'<table id="CT" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="000000" width="100%"  style="cursor:pointer;">'
            +colorTable+'</table>';
