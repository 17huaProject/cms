...
<c:if test="${!readonly}">
<a href="javascript:" onclick="${input}ImageCropeOpen();" class="btn btn-primary">${selectMultiple?'添加':'选择'}</a>&nbsp;
<a href="javascript:" onclick="${input}DelAll();" class="btn btn-default">清除</a>
</c:if>
