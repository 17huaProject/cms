...
<%-- <script src="${ctxStatic}/jquery-validation/1.14.0/additional-methods-custom.js" type="text/javascript"></script> --%>
...
<link rel="stylesheet" type="text/css" href="${ctxStatic}/common/css/z-style.css" />


<link rel="stylesheet" type="text/css" href="${ctxStatic}/jQuery-Tags-Input-master/jquery.tagsinput.css" />
<script type="text/javascript" src="${ctxStatic}/jQuery-Tags-Input-master/jquery.tagsinput.js"></script>


<!-- 引入ueditor文件 -->
<script type="text/javascript">
	window.UEDITOR_HOME_URL = "${ctxStatic}/ueditor143/";
...
<script type="text/javascript" charset="utf-8" src="${ctxStatic}/ueditor143/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctxStatic}/ueditor143/ueditor.all.js"> </script>
<script type="text/javascript" charset="utf-8" src="${ctxStatic}/ueditor143/ueditor.parse.js"> </script>
<script type="text/javascript" charset="utf-8" src="${ctxStatic}/ueditor143/lang/zh-cn/zh-cn.js"></script>


<script type="text/javascript" charset="utf-8" src="${ctxStatic}/jquery-timer/jquery.timer.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctxStatic}/jquery-colorpicker/jquery.colorpicker.js"></script>
