...
*/			   onChange: function(elem, elem_tags){
	...
	function addErrorHint(type){
		$("#"+type+"-error").remove();
		$("#"+type+"-search").after("<label id='"+type+"-error' class='error' style='width:100%' for='"+type+"'>请从提示列表中选择</label>");
...
<body>
	<form:form id="inputForm" action="${ctx}/wms/event/save" commandName="event" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      ...
		      <tr>
		         ...
		         <td><form:input path="capacity" htmlEscape="false" max="1000" class=" form-control  required"/></td>
		      ...
		      <tr>
		         ...
		         <td colspan="3">
					 ...
					 <form:select path="cityCode"  class="required">
						<option value="3101" selected="selected">上海</option>
			  ...
			  <tr>
		         ...
		         <span style="color:green; width:100%;">该活动标签为作品标签,且不可手动添加,选定作品后将自动填充</span>
<!-- 		         <span style="color:green; width:100%;">每个标签至少2个字,按空格键或enter键完成添加</span> -->
		      ...
		      <tr>
		         ...
		         <td colspan=3>
		         	<form:input path="shareDesc" htmlEscape="false" maxlength="20" class="form-control" value="${shareDescList[0]}"/>
