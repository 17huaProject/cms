		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
			    ...
			    <tr>
			   	...
			   	<tr>
			         <td class="active"><label class="pull-right"><font color="red">*</font>画师大图:</label></td>
			         <td>
			         	<form:hidden path="bigImg" htmlEscape="false" maxlength="255" class=""/>
			         	<sys:ckfinder input="bigImg" type="images" uploadPath="/artist/bigImg" selectMultiple="false"/>
			         </td>
			         <td class="active"><label class="pull-right"><font color="red">*</font>画师小图:</label></td>
			         <td>
			         	<form:hidden path="smallImg" htmlEscape="false" maxlength="255" class=""/>
			         	<sys:ckfinder input="smallImg" type="images" uploadPath="/artist/smallImg" selectMultiple="false"/>
			         </td>
			      </tr>
			      <tr>
