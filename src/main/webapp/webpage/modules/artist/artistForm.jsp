...
<body>
	<form:form id="inputForm" action="${ctx}/wms/artist/save" commandName="artist" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
			   	<tr>
			         ...
			         <td><form:input path="artistName" htmlEscape="false" minlength="2" maxlength="50" class=" form-control  required"/></td>
			         <td class="active"><label class="pull-right"><font color="red">*</font>真实姓名:</label></td>
			         <td><form:input path="realname" htmlEscape="false" minlength="2" maxlength="50" class=" form-control  required"/></td>
			      </tr>
			   	<tr>
			   	...
			   	<tr>
			         ...
			         <td><form:input path="phone" htmlEscape="false" maxlength="11" class=" form-control  required"/></td>
			   	...
			   	<tr>
			         ...
			         <td>
			         	<form:input path="artistLevel" htmlEscape="false" maxlength="50" class=" form-control  required" number="true"/>
			         	<div style="color:green; width:100%;">注意：请填数字：1~5</div>
			         </td>
			    </tr>
			    <tr>
			         <td class="active"><label class="pull-right"><font color="red">*</font>身份证号:</label></td>
			         <td><form:input path="idcard" htmlEscape="false" maxlength="18" class=" form-control  required"/></td>
			         <td class="active"><label class="pull-right"><font color="red">*</font>状态:</label></td>
			         <td>
				         <form:select path="status"  class="form-control" disabled="disabled">
							<form:option selected="selected" value="0" label="非公开"/>
							<form:option value="1" label="公开"/>
						 </form:select>
					 </td>
			    </tr>
			     <tr>
