...
<head>
	...
	<script type="text/javascript">
		function refresh(){//刷新
			window.location="${ctx}/wms/order/index";
		}
	</script>
</head>
<body class="gray-bg">
	...
	<div id="content" class="row">
		...
		<div id="right"  class="col-sm-12  animated fadeInRight" style="width:100%">
			<iframe id="artContent" name="artContent" src="${ctx}/wms/order/list" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
	...
	/* 	
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					$('#artContent').attr("src","${ctx}/wms/art/list?office.id="+id+"&office.name="+treeNode.name);
				}
			}
		};
