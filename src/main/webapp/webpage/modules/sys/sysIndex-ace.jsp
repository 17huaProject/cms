				...
				<div class="navbar-header pull-left">
					...
					<a href="#" class="navbar-brand">
						<small>
							...
							<img alt="" src="http://image.17hua.me/upload/image/201709/15057319968751083.png" width="25px" height="25px">
							一起画后台管理系统${fns:getConfig('version')}
						</small>
					</a>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">一起画后台管理系统</span>
							 &copy; 2017-2030
						</span>
