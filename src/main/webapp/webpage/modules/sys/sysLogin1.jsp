				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
												...
												<fieldset>
													...
													<div class="space-4"></div>
														<div id="themeSwitch" class="dropdown">
															<a class="dropdown-toggle" data-toggle="dropdown" href="#">${fns:getDictLabel(cookie.theme.value,'theme','ACE风格')}<b class="caret"></b></a>
							...
							<div class="center"><h4 id="id-company-text"><font color="#A90E0E">&copy; www.17hua.com</font></h4></div>
