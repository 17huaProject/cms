...
<head>
    ...
    <title>一起画后台管理系统</title>

	<%@ include file="/webpage/include/head.jsp"%>
	<script src="${ctxStatic}/common/inspinia.js?v=3.2.0"></script>
	<script src="${ctxStatic}/common/contabs.js"></script> 
    <meta name="keywords" content="一起画后台管理系统">
    <meta name="description" content="一起画后台管理系统">
...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-left"><a href="#">http://www.17hua.me</a> &copy; 2017-2025</div>
            </div>
        </div>
        <!--右侧部分结束-->
...
$(document).ready(function(){
	$("a[href='/yqhCMS/a/wms/event/index']").css("color","red");
