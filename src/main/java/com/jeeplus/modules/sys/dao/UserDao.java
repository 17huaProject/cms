...
public interface UserDao extends CrudDao<User> {
	 ...
	 * @return
	 */
	public List<UserDTO> select4AutoCompleteByExample(String searchKey);

	public UserDTO verifyArtists4Event(@Param(value="id") String id, @Param(value="searchParam") String searchParam);
