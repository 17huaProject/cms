...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		// 校验登录验证码
		String securityCode = (String) request.getParameter("validateCode") ; 
		if (StringUtils.isEmpty(securityCode) || token.getCaptcha() == null || 
				!token.getCaptcha().toLowerCase().equals(securityCode.toLowerCase())){
