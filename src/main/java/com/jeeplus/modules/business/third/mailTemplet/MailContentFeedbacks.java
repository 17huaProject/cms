 ...
 * @author afanti
 */
public class MailContentFeedbacks extends MailContentHTMLTempletAbstract {
	 ...
	 */
	public MailContentFeedbacks(String text , List<String> tableHeader , List<List<String>> tableItems) {
		this.plainText = text ;
