 ...
 * @author afanti
 */
public class MailContentJoinus extends MailContentHTMLTempletAbstract {
	 ...
	 */
	public MailContentJoinus(String text , List<String> tableHeader, List<List<String>> tableItems) {
		this.plainText = text ;
